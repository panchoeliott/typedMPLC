...
rtLetRec4CT = eLetRec4
rtLetRec4RT = eLetRec4
...
-- Lam "i" 
    -- (Lam "n"     
        -- (LetRec "N"
            -- (Lam "count"
                -- (If
                    -- (PrimBin Gt (Var "count") (LitN 1))
                    -- (If
                        -- (PrimBin Eq (Var "count") (Var "i"))                    
                        -- (Let 
                            -- "ith" 
                            -- GenSym 
                            -- (AST [TagExpr TLam, AST [TagExpr TVar,  AST [TagExpr TVarRep, (Var "ith")]], App (Var "N") (PrimBin Min (Var "count") (LitN 1))]))
                        -- (AST [TagExpr TLam, AST [TagExpr TVar, AST [TagExpr TVarRep, GenSym]], App (Var "N") (PrimBin Min (Var "count") (LitN 1))])
                    -- )
                    -- (AST [TagExpr TVar, AST [TagExpr TVarRep, (Var "ith")]])            
                -- )
            -- )        
            -- (App (Var "N") (Var "n"))    
        -- )
...
ithnaryproj = Lam "i" (Lam "n"     (Let "ith" (AST [TagExpr TVar,  AST [TagExpr TVarRep, GenSym]])  (LetRec "N"         (Lam "count"             (If                 (PrimBin Gt (Var "count") (LitN 1))                 (If                     (PrimBin Eq (Var "count") (Var "i"))                    ((AST [TagExpr TLam, (Var "ith"), App (Var "N") (PrimBin Min (Var "count") (LitN 1))]))                    (AST [TagExpr TLam, AST [TagExpr TVar, AST [TagExpr TVarRep, GenSym]], App (Var "N") (PrimBin Min (Var "count") (LitN 1))])                )                (Var "ith")            )         )        (App (Var "N") (Var "n"))    )))
